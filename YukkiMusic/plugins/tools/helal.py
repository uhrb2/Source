...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/8dd0073b63070f25f3645.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "ســٰٰٰ๋ٖٖٖۧ͜ــ۫͜ــورس ٰيٰہٰوآ", callback_data=f"devhelp"),
                ],[
                    InlineKeyboardButton(
...
•═════•| 𝐿𝐔𝐴 |•═════•""",reply_markup=InlineKeyboardMarkup(
            [
                [
                      InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "ســٰٰٰ๋ٖٖٖۧ͜ــ۫͜ــورس ٰيٰہٰوآ", callback_data=f"devv"),
                ],[
                    InlineKeyboardButton(
...
6 ← اوامر الادمن .""",
       reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    InlineKeyboardButton(
                        "ســٰٰٰ๋ٖٖٖۧ͜ــ۫͜ــورس ٰيٰہٰوآ", callback_data=f"devmusic"),
                ],[
                    InlineKeyboardButton(
               "عـوده 𖡃", callback_data=f"ayamr"),
               ],
...
async def tt(_, query: CallbackQuery):
   await query.edit_message_caption(caption =f"""ٓ[ٓ❍ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 𝑳𝐔𝐀 .](https://t.me/RDPDDP)
...
async def devhelp(_, query: CallbackQuery):
   await query.edit_message_caption(caption =f"""[ٓ❍ | 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 𝑳𝐔𝐀 .](https://t.me/RDPDDP)\n\n[❍ | 𝑳𝐔𝐀 𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞 𝐎𝐧 𝐓𝐞𝐥𝐞 .](https://t.me/RDPDDP)\n\n[❍ | 𝐅𝐨𝐥𝐥𝐨𝐰 𝐓𝐡𝐞 𝐁𝐮𝐭𝐭𝐨𝐧𝐬 𝐁𝐞𝐥𝐨𝐰 .](https://t.me/RDPDDP)""",
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton(
                        "𝒄𝒉𝒂𝒏𝒏𝒆 𝒍𝒖𝒂", url=f"https://t.me/RDPDDP"),
                    InlineKeyboardButton(
                        "𝒔𝒖𝒑𝒑𝒐𝒓𝒕 𝒍𝒖𝒂", url=f"https://t.me/K_1_1_0_0")
                ],[
                    InlineKeyboardButton(
                        "EᖇᖇOᖇ", url=f"https://t.me/K_1_1_0"),
                ],[
                    InlineKeyboardButton(
                        "عـوده 𖡃", callback_data=f"ayamr"),
               ], 
